const UnauthorizedEntry = () => {
  return (
    <>
      ...
      >
        <div className="">
          <h1 className="text-4xl text-gray-300">403 - Yetkisiz Erişim</h1>
          <p className="text-gray-400 mt-4">
            Bu sayfaya erişim izniniz yok. Lütfen giriş yapın veya yetkili bir
            kullanıcıdan yardım isteyin.
          </p>
          <a
            href="/login"
