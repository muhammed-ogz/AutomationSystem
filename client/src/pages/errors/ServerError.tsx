const NotFound = () => {
  return (
    <>
      ...
      >
        <div className="">
          <h1 className="text-4xl text-gray-300">500 - Sunucu Hatası</h1>
          <p className="text-gray-400 mt-4">
            Endişelenmeyin, bu bir sunucu hatası. Lütfen daha sonra tekrar
            deneyin. Eğer sorun devam ederse, lütfen destek ekibiyle iletişime
            geçin.
          </p>
          <a
            href="/"
